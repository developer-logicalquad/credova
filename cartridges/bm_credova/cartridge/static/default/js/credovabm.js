...
ready(() => {
    if (document.querySelector('button.stripe-quick-setup-submit')) {
        ...
        document.querySelector('button.stripe-quick-setup-submit').addEventListener('click', (e) => {
            ...
            var stripeQuickSetupForm = document.getElementById('credova-quick-setup-form');
            ...
            var formData = document.getElementById('credova-quick-setup-form').serialize();
            ...
            httpRequest.open('POST', document.getElementById('credova-quick-setup-form').action, true);
