...
server.replace('SubmitPayment', server.middleware.https, csrfProtection.validateAjaxRequest, function s(req, res, next) {
    ...
    this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
        ...
        delete billingData.paymentInformation;
        var publicId = req.session.privacy.publicId;
        billingForm.credovaFields.publicId.value = publicId;
        res.json({
